...
public class Course implements ManageTask  {
	...
	public void AddAssignment(String assignName, String assignBody) {
		...
		String[] placeholders = new String[] {"assign#"+assignName, assignBody};
		// do some logic here 
	...
	public void AddExam(String examName, String examBody) {
		...
		String[] placeholders = new String[] {"exam#"+examName, examBody};
		// do some logic here
	...
	public void AddGrades(String name, String grade) {
		...
		String[] placeholders = new String[]{"Grade#"+this.name, grade};
		// do some logic here
	...
	public void AddAnn(String AnnName, String AnnBody) {
		...
		String[] placeholders = new String[]{"Ann#"+AnnName, AnnBody};
		// do some logic here
